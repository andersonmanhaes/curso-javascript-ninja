...
carro.entraPessoas = function(numPessoas) {
  if (numPessoas <= 0) {
    return 'Número inválido de passoa para entrar no carro!';
  ...
  } else if ((carro.assentos - carro.quantidadePessoas) === 1 && numPessoas != 1) {
...
carro.entraPessoas(3); //O carro já está lotado!
